...
trj_file = os.path.join(path, 'glycine_1w_real.lammpstrj')
xyz_file = os.path.join(path, 'glycine_c_3.xyz')

xyz_index, atoms = lmp_index(trj_file)
#print(xyz_index, atoms)

write_xyz(xyz_index[53:54], atoms, trj_file, xyz_file, imq_dict)