...
# grid related
parser.add_argument('--min',dest='grid_min',type=str,default="-1.1,-1.0",help='lower bounds for the grid')
parser.add_argument('--max',dest='grid_max',type=str,default="1.1,12.0", help='upper bounds for the grid')
parser.add_argument('--bin',dest='grid_bin',type=str,default="200,200", help='number of bins for the grid')
# blocks
