...
cv_fig(data,["s05"],["d05"],["d05"],"CV:Solvation_L05","CV:Iondistance_L05",savepath,1,False)
cv_colorbar_fig(data,["time"],["s05"],["s05"],"Time (ps)","CV:Solvation with bias",  ["opes.bias"], savepath,10,False)
cv_colorbar_fig(data,["time"],["d05"],["d05"],"Time (ps)","CV:IonDistance with bias",["opes.bias"], savepath,10,False)
